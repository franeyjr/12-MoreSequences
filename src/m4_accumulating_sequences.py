...
def run_test_make_simple_string():
    ...
    # Test 2:
    expected = '15-16-17-18-19-20-21-'
    actual = make_simple_string(15,21)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    # Test 2:
    expected = '15-16-17-18-19-20-21'
    actual = make_less_simple_string(15,21)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    rectangles = []
    for k in circles:
        rectangles = rectangles + [rg.Rectangle(rg.Point(k.center.x - k.radius,k.center.y - k.radius),rg.Point(k.center.x + k.radius,k.center.y + k.radius))]
    return rectangles
