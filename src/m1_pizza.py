...
def run_test_draw_points_on_circle():
    ...
    title = 'Test 4: '
    window = rg.RoseWindow(400,400,title)
    circle = rg.Circle(rg.Point(250,125),100)
...
def run_test_pizza():
    ...
    circle = rg.Circle(rg.Point(350,150),125)
    circle.fill_color = 'blue'
    circle.outline_thickness = 5
    pizza(window,circle,8,'white',3)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    polygon(window,circle,10,'green',3)
    window.close_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    circle = rg.Circle(rg.Point(350,350),200)
    circle.fill_color = 'red'
    fancy_polygon(window,circle,50,25,'blue',3)
    window.continue_on_mouse_click()
    ...
    circle = rg.Circle(rg.Point(350,350),200)
    circle.fill_color = 'red'
    fancy_polygon(window,circle,50,10,'blue',3)
    window.close_on_mouse_click()
...
def fancy_polygon(window, circle, number_of_lines, hops_to_next_point, color,
    ...
    for k in range(number_of_lines):
        line = rg.Line(generate_points_on_circle(circle,number_of_lines)[k],generate_points_on_circle(circle,number_of_lines)[k-hops_to_next_point])
        line.color = color
        line.thickness = thickness
        line.arrow = 'last'
        line.attach_to(window)
